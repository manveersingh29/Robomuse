...
//double KpL = 25, KiL = 1, KdL = 0, outputL = 0; // Proportional, Integral & Derivative coefficients
//double KpR = 25, KiR = 1, KdR = 0, outputR = 0;  // of respective motors for PID control
